        ...
        public static void Initialize(StoreContext context)
        {
            ...
            var products = new List<Product>
            {
                new Product
                {
                    ...
                    Price = 400,
                    PictureUrl = "/images/products/animal-farm.jpg",
                    QuantityInStock = 1
                },
                new Product
                {
                    ...
                    Price = 300,
                    PictureUrl = "/images/products/frankenstein.jpg",
                    QuantityInStock = 1
                },
                new Product
                {
                    ...
                    Price = 400,
                    PictureUrl = "/images/products/les-miserables.jpg",
                    QuantityInStock = 1
                },
                new Product
                {
                    ...
                    Price = 250,
                    PictureUrl = "/images/products/little-women.jpg",
                    QuantityInStock = 1
                },
                new Product
                {
                    ...
                    Price = 400,
                    PictureUrl = "/images/products/pride-and-prejudice.jpg",
                    QuantityInStock = 1
                },
                new Product
                {
                    ...
                    Price = 100,
                    PictureUrl = "/images/products/hamlet.jpg",
                    QuantityInStock = 1
                },
                new Product
                {
                    ...
                    Price = 300,
                    PictureUrl = "/images/products/the-great-gatsby.jpg",
                    QuantityInStock = 1
                },
                new Product
                {
                    ...
                    Price = 250,
                    PictureUrl = "/images/products/crime-and-punishment.jpg",
                    QuantityInStock = 1
                },
            };
